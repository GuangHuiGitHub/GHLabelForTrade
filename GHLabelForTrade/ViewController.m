...
- (void)viewDidLoad {
    ...
    [self creatGHLabel:@"社会生产力的发展产生" andFrame:CGRectMake(50, 170, 200, 50)];
    
    [self creatGHLabel:@"社会生产力的发展产生出用于交" andFrame:CGRectMake(50, 280, 200, 50)];
    
    [self creatGHLabel:@"社会生产力的发展产生出用于交换的剩余商品，这些剩余商品在国与国之间交换，就产生了国际贸易。社会生产力的发展产生出用于交换的剩余商品，这些剩余商品在国与国之间交换，就产生了国际贸易。" andFrame:CGRectMake(50, 400, 200, 50)];
}
